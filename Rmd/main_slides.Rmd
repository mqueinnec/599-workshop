...
my_random_effects_model <- lmer(body_mass_g ~   bill_length_mm + (1|species), data = dat)

dat$predict_random <- predict(my_random_effects_model)

dat$resid_randm <-  resid(my_random_effects_model)
